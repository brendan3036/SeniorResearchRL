...
#class sit_in_net():
    # our goal is to be maxin and relaxin in net until we need to go save the ball
    # Vector3(0, -1 * 5100, 320) --- > coordinates of center of goaline
    # self.left_post = Vector3(-1 * 850, -1 * 5100, 320)
    #    self.right_post = Vector3(1 * 850, -1 * 5100, 320)
    # def __init__(self, ball_location, target, vector, direction):
